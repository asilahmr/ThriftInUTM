...
const HomeScreen = ({ navigation }) => {
  ...
  const fetchRecommendations = async () => {
    try {
      ...
      console.log('✅ Recommendations loaded:', response.data?.length || 0);
    ...
    return (
      ...
      >
        ...
        <View style={styles.productInfo}>
          ...
          <Text style={styles.productPrice}>RM {parseFloat(item.price).toFixed(2)}</Text>
  ...
  const renderRecommendationCard = ({ item }) => {
    ...
    return (
      ...
      >
        ...
        <Text style={styles.recommendationPrice}>RM {parseFloat(item.price).toFixed(2)}</Text>
      </TouchableOpacity>
    );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Find your perfect preloved items</Text>
      </View>
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtext}>
              {searchQuery ? 'Try a different search' : 'Be the first to list an item!'}
            </Text>
          </View>
        }
        refreshControl={
